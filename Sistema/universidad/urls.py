...
from .views import vista_materias, materias_no_asociadas, estudiante, materias, asignacion, vista_asignacion_por_estudiante, vista_asignacion, vista_estudiante, VistaPrincipal, vista_estudiante_cedula, vista_materias_nombre
